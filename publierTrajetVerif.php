...
try {
    ...
    $req = $mabd->prepare('INSERT INTO trajets (_park_id, _user_id, destination, date, traj_heure_depart, traj_places) VALUES (:park_id, :user_id, :destination, :date, :heure, :places)');
